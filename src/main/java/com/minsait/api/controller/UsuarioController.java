...
public class UsuarioController implements UsuarioSwagger {
    ...
    public ResponseEntity<Page<UsuarioResponse>> findAll(
        ...
        final Page<UsuarioResponse> usuarioResponsePage = ObjectMapperUtil.mapAll(usuarioEntityPage, UsuarioResponse.class);
    ...
    public ResponseEntity<UsuarioResponse> insert(@RequestBody UsuarioRequest usuarioRequest) {
        ...
        UsuarioResponse usuarioResponse = ObjectMapperUtil.map(createdUsuarioEntity, UsuarioResponse.class);
